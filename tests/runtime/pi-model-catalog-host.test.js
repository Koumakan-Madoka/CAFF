...
test('Pi catalog host projects exact pinned thinking capabilities without credentials or network', async (t) => {
  ...
  assert.deepEqual(snapshot.source, {
    codingAgent: { name: '@earendil-works/pi-coding-agent', version: '0.80.10' },
    piAi: { name: '@earendil-works/pi-ai', version: '0.80.10' },
  });
  ...
  const expected = new Map([
    ...
    ['groq\u001fqwen/qwen3-32b', ['off', 'high']],
    ['zai\u001fglm-5.2', ['off', 'low', 'medium', 'high', 'max']],
