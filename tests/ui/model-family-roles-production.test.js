  ...
  const agents = [
    {
      ...
      editableFields: ['provider', 'model', 'thinking', 'modelProfiles', 'isDefaultChatRole', 'sessionReuseEnabled'],
    },
    {
    ...
    },
    {
      ...
      editableFields: ['name', 'description', 'sandboxName', 'avatarDataUrl', 'personaPrompt', 'provider', 'model', 'thinking', 'accentColor', 'skillIds', 'modelProfiles', 'isDefaultChatRole', 'sessionReuseEnabled'],
