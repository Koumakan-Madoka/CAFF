...
import { installProxyOnlyRoutingDispatcher, isProxyOnlyRoutingConfigured } from './proxy-routing.mjs';
...
export function repairEnvProxyGlobalDispatcher() {
  if (isProxyOnlyRoutingConfigured()) {
    // PROXY_ONLY_HOSTS owns the global dispatcher; the whitelist routing
    // dispatcher from proxy-routing.mjs replaces this repair entirely.
    return;
  }
