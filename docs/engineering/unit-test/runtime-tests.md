...
- Add regression tests when changing prompt assembly, path validation, active
  project rules, or structured Goal delivery contracts
...
- `tests/runtime/agent-tool-bridge.test.js`: bridge authentication, structured
  Goal updates, pending-proposal preservation, and retired writer absence
- `tests/runtime/turn-orchestrator.test.js`: prompt assembly and structured
  Goal context
