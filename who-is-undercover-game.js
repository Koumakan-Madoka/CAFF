...
const UNDERCOVER_CONVERSATION_TYPE = 'who_is_undercover';
const UNDERCOVER_SKILL_ID = 'who-is-undercover';
...
function validateGameConfig(config = {}, playerCount = 0) {
...
class WhoIsUndercoverHost {
  ...
  createGame(conversation, rawConfig = {}) {
  ...
  applyVoteResult(state, voteResult = {}) {
    const nextState = {
      ...state,
...
function createWhoIsUndercoverHost(options = {}) {
