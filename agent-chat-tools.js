...
async function resolveMessageContent(flags = {}, options = {}) {
...
async function sendPublic(config, flags, options = {}) {
...
async function sendPrivate(config, flags, options = {}) {
  const content = await resolveMessageContent(flags, options);
...
function shouldEchoContent(flags = {}, env = process.env) {
  return (
...
function formatCommandResult(command, result, flags = {}, env = process.env) {
