...
function serializeConversationPrivateMessageForUi(message, agents) {
...
function withConversationPrivateMessages(conversation, store) {
  if (!conversation) {
    return null;
  }
...
module.exports = {
  ...
  serializeConversationPrivateMessageForUi,
  withConversationPrivateMessages,
};
