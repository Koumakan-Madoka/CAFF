...
{ "command": "{{PYTHON_CMD}} .trellis/hooks/script.py" }
...
- [ ] New command/skill added to every enabled platform config in this repo
...
When integrating with external tools (OpenCode, Cursor, etc.), their API contracts are **implicit assumptions**.
