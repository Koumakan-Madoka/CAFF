...
- `tests/runtime/session-goal-owner.test.js`
  - Owner normalization/persistence, accept-proposal stamping of `proposedBy`, `set-owner` validation (missing goal, non-participant, empty clear), direct-set stays ownerless, prompt `Owner` line.
