...
def cmd_summary(repo_root: Path, filter_assignee: str | None = None) -> int:
    ...
    for t in iter_active_tasks(tasks_dir):
        ...
        if agent_info:
            ...
            agent_platform = agent_info.get("platform", "")
        ...
        for t in stopped_tasks:
            if t["status"] == "completed":
                ...
                if t["session_id_file"].is_file():
                    ...
                    last_msg = get_last_message(t["log_file"], 150, platform=platform)
                    print(
                    ...
                    if platform:
                        ...
                        print(f"{Colors.DIM}(resume unavailable: unknown platform){Colors.NC}")
                else:
                    print(
